...
export default function AcceptInvite() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // signed in as themselves opening someone else's invite link). Falling through
      // to updateUser on an unverified token acts on whoever is currently
      // authenticated, not the invited person — that overwrote a real account in
      ...
      if (tokenHash && !tokenVerified) {
        ...
        // ambient session with the invited user's real session. Flip this
